(function() {
  $(document).ready(function() {
    var animController, handleResize, initAnimated, initStatic, isMobile, s1, s2, s3, screenSize, shuttle, shuttleNose;
    ...
    initStatic = function() {
      ...
      return $('#animation-wrapper').find('section').addClass('no-bg');
    };
    initAnimated = function() {
      var angularBox, apacheBox, chefBox, linuxBox, mongoBox, mysqlBox, nodeBox, postgresBox, rubyBox;
      ...
      return animController.addTween(s3, TweenMax.to(shuttle, 0.1, {
        bottom: 600,
        scale: 0.8,
        ease: EaseLookup.find('Quad.easeIn')
      }), 300, 400);
